#!/usr/bin/env python3
"""Test the LangGraph agent with the events question"""
...
async def test_events_question():
    """Test agent with the events question"""
    
    print("=== TESTING EVENTS QUESTION ===\n")
...
if __name__ == "__main__":
    asyncio.run(test_events_question())