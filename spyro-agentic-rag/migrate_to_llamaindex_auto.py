#!/usr/bin/env python3
"""
Migrate existing Spyro RAG data to LlamaIndex schema format (auto mode)
...
def migrate_to_llamaindex():
    ...
    with driver.session() as session:
        ...
        logger.info(f"Proceeding with migration of {total_count} entities...")
        ...
        entity_types = ['CUSTOMER', 'PRODUCT', 'TEAM', 'PROJECT', 'RISK', 'SUBSCRIPTION', 
                        'REVENUE', 'FEATURE', 'ROADMAP_ITEM', 'OBJECTIVE', 'EVENT', 
                        'COST', 'PROFITABILITY']
...
if __name__ == "__main__":
    print("=== SPYRO RAG TO LLAMAINDEX MIGRATION (AUTO MODE) ===")
    print("\nThis script will automatically migrate all existing entities to LlamaIndex schema format.")
